...
//public static class ObjectMapper
//{
//    private static readonly Dictionary<(Type sourceType, string propName), PropertyInfo> _propertyCache = new();
...
//        foreach (var sourceProp in sourceProperties)
//        {
//            var cacheKey = (sourceType, sourceProp.Name);
//            if (!_propertyCache.TryGetValue(cacheKey, out var destProp))
//            {
//                destProp = destinationProperties.FirstOrDefault(p => p.Name == sourceProp.Name && p.CanWrite);
//                if (destProp != null)
//                {
//                    _propertyCache[cacheKey] = destProp;
//                }
//            }
...
//        foreach (var item in source)
//        {
//            if (item is not null && !(item is ValueType || item is string))
//            {
//                var mappedItem = ((dynamic)item).Map(itemType); // Dynamically resolve the Map method
//                destinationList.Add(mappedItem);
//            }
//            else
//            {
//                // If it's a simple type, just add it as is
